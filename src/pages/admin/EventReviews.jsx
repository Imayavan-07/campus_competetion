...
const DEFAULT_REVIEW_EVENTS = [
  ...
  },
  {
    ...
    overallRating: 4.9,
    adminEventFeedback: {
      feedback: 'Flawless varsity fixture with punctual round arbitrations. Noise dampening protocol from the dining hall was strictly maintained. Live broadcast boards operated with 100% uptime. Approved for expanded state league fixtures next semester.',
      adminName: 'Office of Campus Administration',
      date: 'Sept 01, 2026'
    },
    reviews: [
          ...
          <div className="flex justify-between items-start flex-wrap gap-6">
            <div className="flex-1 min-w-[300px]">
              <div className="flex items-center gap-2 mb-3">
                <span className="event-category-tag">{selectedEvent.category}</span>
    ...
    <div className="event-directory-wrapper">
      ...
      <div className="event-control-bar">
        <div className="event-search-box">
          ...
          <input 
            type="text" 
            placeholder="Search reviews by event title, organizing club, or category..." 
            value={search}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {filteredEvents.map(event => {
          return (
            ...
            >
              <div>
                {/* Top Row: Category Tag & Overall Rating Badge */}
