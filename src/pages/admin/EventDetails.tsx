      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="event-glass-card">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-gray-100 dark:border-neutral-800 text-xs">
              {/* Conducted by Club */}
              <div className="p-3.5 rounded-2xl bg-neutral-50 dark:bg-neutral-900/60 border border-gray-100 dark:border-neutral-800">
                <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider block mb-1">
                  Conducted By Club
                </span>
                <div className="flex items-center gap-2 mt-1">
                  <ClubsIcon className="w-4 h-4 text-blue-600 shrink-0" />
                  <span className="font-extrabold text-main text-sm">{event.club}</span>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-neutral-50 dark:bg-neutral-900/60 border border-gray-100 dark:border-neutral-800">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="font-extrabold text-main text-sm">{event.academicYear || 'AY 2026 - 2027'}</span>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-neutral-50 dark:bg-neutral-900/60 border border-gray-100 dark:border-neutral-800">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="font-extrabold text-main text-sm">{selectedVenue || event.venue}</span>
                </div>
              </div>
          ...
          <div className="event-glass-card">
            ...
            {!isEditingBudget ? (
              <div className="flex flex-col gap-4">
                ...
                {/* Custom Items Posted by Club */}
                {event.budgetBreakdown?.customItems && event.budgetBreakdown.customItems.length > 0 && (
                  <div className="pt-3 border-t border-gray-100 dark:border-neutral-800">
                    <span className="text-[11px] uppercase font-bold text-gray-400 tracking-wider block mb-2.5">
                      Club Line Items & Special Equipment
                    </span>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
                      {event.budgetBreakdown.customItems.map((item, i) => (
                        <div 
                          key={item.id || i}
                          className="flex justify-between items-center p-3 rounded-xl bg-neutral-50 dark:bg-neutral-900/60 border border-gray-100 dark:border-neutral-800"
                        >
          ...
          <div className="event-glass-card">
            ...
            <div className="mb-4 text-xs text-muted">
              <strong className="text-main">Target Audience:</strong> {event.registration?.targetAudience || 'Undergraduate & Postgraduate Students, Club Delegates & Faculty'}
            </div>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <span className="text-muted text-[11px]">{del.reg}</span>
                        </div>
                      </div>
