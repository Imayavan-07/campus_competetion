...
const DEFAULT_CLUBS = [
  { id: 1, name: 'Campus Photography Club', dept: 'Arts & Culture', category: 'Cultural & Arts', members: 45, events: 3, president: 'Evan Wright', coordinator: 'Alice Johnson', email: 'photography@university.edu' },
  { id: 2, name: 'Robotics Society', dept: 'Engineering', category: 'Technical Society', members: 120, events: 1, president: 'Jane Doe', coordinator: 'Bob Smith', email: 'robotics@university.edu' },
  { id: 3, name: 'Debate & Oratory Team', dept: 'Arts & Culture', category: 'Cultural & Arts', members: 30, events: 5, president: 'Michael Scott', coordinator: 'Alice Johnson', email: 'debate@university.edu' },
  { id: 4, name: 'Quantum & Chess Guild', dept: 'Science', category: 'Academic & Research', members: 25, events: 2, president: 'Beth Harmon', coordinator: 'Fiona Gallagher', email: 'chess@university.edu' },
  { id: 5, name: 'Collegiate Esports League', dept: 'Sports', category: 'Sports & Athletics', members: 88, events: 4, president: 'Tenzing Norgay', coordinator: 'George Miller', email: 'esports@university.edu' },
  { id: 6, name: 'Renewable Energies Club', dept: 'Engineering', category: 'Technical Society', members: 54, events: 2, president: 'Claire Bennett', coordinator: 'Diana Prince', email: 'renewables@university.edu' },
];
          ...
          >
            ...
            <div className="pt-3 border-t border-gray-100 dark:border-neutral-800 flex items-center justify-between gap-3">
              <div className="text-xs text-muted font-medium flex items-center gap-1.5 truncate">
                ...
                <span className="truncate">{club.category || club.email || 'Campus Society'}</span>
              </div>
        ...
        {filteredClubs.length === 0 && (
          <div className="col-span-1 md:col-span-2 card text-center py-16">
            ...
            <p className="text-xs text-muted max-w-sm mx-auto mb-5">
              Try adjusting your search query, department category, or clear custom filters.
            </p>
