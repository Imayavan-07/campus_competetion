        ...
        <div className="card" style={{ padding: '28px' }}>
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-neutral-800">
            ...
            <div>
              ...
              <p className="text-muted text-xs">Official institutional identification and category registration</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="Social Impact & Welfare">Social Impact & Welfare</option>
