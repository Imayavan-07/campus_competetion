      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        >
          <div>
            ...
            {/* Visual Department Distribution Bar */}
            <div className="py-2 mb-3">
              <div className="flex justify-between items-center text-xs mb-1.5">
                <span className="font-bold text-muted text-[11px]">Society Affiliation</span>
                <span className="font-extrabold text-main">362 Student Members</span>
              </div>

              <div className="segmented-dist-bar mb-2">
                <div style={{ width: '45%', background: '#3b82f6' }} className="segmented-dist-seg" title="Engineering: 45%" />
                <div style={{ width: '30%', background: '#8b5cf6' }} className="segmented-dist-seg" title="Arts & Media: 30%" />
                <div style={{ width: '15%', background: '#16A34A' }} className="segmented-dist-seg" title="Athletics: 15%" />
                <div style={{ width: '10%', background: '#F59E0B' }} className="segmented-dist-seg" title="Sciences: 10%" />
              </div>
            ...
            <div className="py-2 mb-3">
              ...
              <div className="capacity-progress-track mb-2">
                <div 
                  ...
                  style={{ width: '96%', background: 'linear-gradient(90deg, #F59E0B 0%, #16A34A 100%)' }}
                />
              </div>
                ...
                <div className="audit-feed-card">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 flex-wrap mb-1">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-black text-main">Term Seed Grant Disbursed</span>
                          <span className="badge badge-purple text-[10px] font-bold py-0.5 px-2">Financial</span>
                        </div>
                        <span className="text-[11px] font-bold text-main bg-white dark:bg-neutral-800 py-0.5 px-2 rounded-md border border-gray-100 dark:border-neutral-700">
                          Sep 11, 10:00 AM
                        </span>
                      ...
                      <p className="text-xs text-muted font-medium mb-1">
                        $2,400 allocated to Robotics & Autonomous Systems Guild for Fall 2026 competitions
                      </p>
                      <span className="text-[11px] text-muted font-semibold block">
                        Authorized by: <strong className="text-main font-bold">University Finance & Treasury</strong>
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <form onSubmit={handleCreateClub}>
          ...
          <div className="form-group">
            ...
            >
              ...
              <option value="Arts">Faculty of Fine Arts & Media</option>
              <option value="Sports">Department of Athletics</option>
              <option value="Science">Faculty of Natural Sciences</option>
